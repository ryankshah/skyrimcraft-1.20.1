...
public class SkyrimcraftProjectile extends AbstractHurtingProjectile
{
    ...
    public SkyrimcraftProjectile(EntityType<? extends AbstractHurtingProjectile> pType, Level pLevel) {
        super(pType, pLevel);
    }

    public SkyrimcraftProjectile(EntityType<? extends AbstractHurtingProjectile> pType, Level pLevel, Entity pShooter) {
        super(pType, pLevel);

        this.setOwner(pShooter);
    }

    public SkyrimcraftProjectile(EntityType<? extends AbstractHurtingProjectile> pType, Level pLevel, Entity pShooter, float power) {
