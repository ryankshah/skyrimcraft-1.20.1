...
public class PowerVoiceOfTheEmperor extends Spell
{
    ...
    public ResourceLocation getDisplayAnimation() {
        return new ResourceLocation(Constants.MODID, "spells/voice_of_the_emperor.png");
    }

    @Override
    public ResourceLocation getIcon() {
        return new ResourceLocation(Constants.MODID, "spells/icons/voice_of_the_emperor.png");
    }
