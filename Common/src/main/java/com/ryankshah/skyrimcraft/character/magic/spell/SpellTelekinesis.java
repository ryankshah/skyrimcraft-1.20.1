...
public class SpellTelekinesis extends Spell
{
    ...
    public ResourceLocation getDisplayAnimation() {
        return new ResourceLocation(Constants.MODID, "spells/blue_spell.png");
    }

    @Override
    public ResourceLocation getIcon() {
        return new ResourceLocation(Constants.MODID, "spells/icons/telekinesis.png");
    }
    ...
    @Override
    public void onCast() {
        if (getCaster() == null || !(getCaster().level() instanceof ServerLevel level)) {
            return;
        }
    ...
    private boolean hasSufficientMagicka() {
        return getCaster() != null &&
                Services.PLATFORM.getCharacter(getCaster()).getMagicka() >= getCost();
    }
}