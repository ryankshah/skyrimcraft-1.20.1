...
//    public static final RegistryObject<Item> BLISTERWORT = ITEMS.register("blisterwort", () -> new SkyrimIngredient(new Item.Properties(), IngredientEffect.DAMAGE_STAMINA, IngredientEffect.FRENZY, IngredientEffect.RESTORE_HEALTH, IngredientEffect.FORTIFY_SMITHING));
    ...
    public static final Supplier<SwordItem> ANCIENT_NORD_SWORD = ITEMS.register("ancient_nord_sword", () -> new SwordItem(ItemTier.ANCIENT_NORD, new Item.Properties().attributes(SwordItem.createAttributes(ItemTier.ANCIENT_NORD, 6, -2.4f))));
    public static final Supplier<SkyrimTwoHandedSword> ANCIENT_NORD_BATTLEAXE = ITEMS.register("ancient_nord_battleaxe", () -> new SkyrimTwoHandedSword(ItemTier.ANCIENT_NORD, new Item.Properties().attributes(SwordItem.createAttributes(ItemTier.ANCIENT_NORD, 8, -3.2f))));
    public static final Supplier<SkyrimTwoHandedSword> ANCIENT_NORD_GREATSWORD = ITEMS.register("ancient_nord_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.ANCIENT_NORD, new Item.Properties().attributes(SwordItem.createAttributes(ItemTier.ANCIENT_NORD, 7, -2.8f))));
    public static final Supplier<SwordItem> ANCIENT_NORD_WAR_AXE = ITEMS.register("ancient_nord_war_axe", () -> new SwordItem(ItemTier.ANCIENT_NORD, new Item.Properties().attributes(SwordItem.createAttributes(ItemTier.ANCIENT_NORD, 7, -2.8f))));
    ...
    public static final Supplier<ShieldItem> DAEDRIC_SHIELD = ITEMS.register("daedric_shield", () -> new ShieldItem(new Item.Properties().stacksTo(1).durability(672)));
    ...
    public static final Supplier<SwordItem> DAEDRIC_DAGGER = ITEMS.register("daedric_dagger", () -> new SwordItem(ItemTier.DAEDRIC, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DAEDRIC, 5, -1.8f))));
    public static final Supplier<SwordItem> DAEDRIC_SWORD = ITEMS.register("daedric_sword", () -> new SwordItem(ItemTier.DAEDRIC, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DAEDRIC, 8, -2.4f))));
    public static final Supplier<SkyrimTwoHandedSword> DAEDRIC_BATTLEAXE = ITEMS.register("daedric_battleaxe", () -> new SkyrimTwoHandedSword(ItemTier.DAEDRIC, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DAEDRIC, 10, -3.2f))));
    public static final Supplier<SkyrimTwoHandedSword> DAEDRIC_GREATSWORD = ITEMS.register("daedric_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.DAEDRIC, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DAEDRIC, 9, -2.8f))));
    public static final Supplier<SwordItem> DAEDRIC_MACE = ITEMS.register("daedric_mace", () -> new SwordItem(ItemTier.DAEDRIC, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DAEDRIC, 9, -3.0f))));
    public static final Supplier<SwordItem> DAEDRIC_WAR_AXE = ITEMS.register("daedric_war_axe", () -> new SwordItem(ItemTier.DAEDRIC, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DAEDRIC, 9, -2.8f))));
    public static final Supplier<SkyrimTwoHandedSword> DAEDRIC_WARHAMMER = ITEMS.register("daedric_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.DAEDRIC, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DAEDRIC, 11, -3.4f))));
...
//    public static final Supplier<SwordItem> DRAGONBONE_ARROW = ITEMS.register("dragonbone_arrow", () -> new SkyrimArrow.DragonboneArrow(new Item.Properties().fireResistant(), "Dragonbone Arrow"));
    public static final Supplier<SwordItem> DRAGONBONE_DAGGER = ITEMS.register("dragonbone_dagger", () -> new SwordItem(ItemTier.DRAGONBONE, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DRAGONBONE, 5, -1.8f))));
    public static final Supplier<SwordItem> DRAGONBONE_SWORD = ITEMS.register("dragonbone_sword", () -> new SwordItem(ItemTier.DRAGONBONE, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DRAGONBONE, 8, -2.4f))));
    public static final Supplier<SwordItem> DRAGONBONE_BATTLEAXE = ITEMS.register("dragonbone_battleaxe", () -> new SwordItem(ItemTier.DRAGONBONE, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DRAGONBONE, 10, -3.2f))));
    public static final Supplier<SkyrimTwoHandedSword> DRAGONBONE_GREATSWORD = ITEMS.register("dragonbone_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.DRAGONBONE, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DRAGONBONE, 9, -2.8f))));
    public static final Supplier<SwordItem> DRAGONBONE_MACE = ITEMS.register("dragonbone_mace", () -> new SwordItem(ItemTier.DRAGONBONE, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DRAGONBONE, 9, -3.0f))));
    public static final Supplier<SwordItem> DRAGONBONE_WAR_AXE = ITEMS.register("dragonbone_war_axe", () -> new SwordItem(ItemTier.DRAGONBONE, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DRAGONBONE, 9, -2.8f))));
    public static final Supplier<SkyrimTwoHandedSword> DRAGONBONE_WARHAMMER = ITEMS.register("dragonbone_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.DRAGONBONE, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DRAGONBONE, 11, -3.4f))));
    ...
    public static final Supplier<ShieldItem> DWARVEN_SHIELD = ITEMS.register("dwarven_shield", () -> new ShieldItem(new Item.Properties().stacksTo(1).durability(412)));
    ...
    public static final Supplier<SwordItem> DWARVEN_DAGGER = ITEMS.register("dwarven_dagger", () -> new SwordItem(ItemTier.DWARVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DWARVEN, 4, -1.8f))));
    public static final Supplier<SwordItem> DWARVEN_SWORD = ITEMS.register("dwarven_sword", () -> new SwordItem(ItemTier.DWARVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DWARVEN, 7, -2.4f))));
    public static final Supplier<SkyrimTwoHandedSword> DWARVEN_BATTLEAXE = ITEMS.register("dwarven_battleaxe", () -> new SkyrimTwoHandedSword(ItemTier.DWARVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DWARVEN, 9, -3.2f))));
    public static final Supplier<SkyrimTwoHandedSword> DWARVEN_GREATSWORD = ITEMS.register("dwarven_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.DWARVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DWARVEN, 8, -2.8f))));
    public static final Supplier<SwordItem> DWARVEN_MACE = ITEMS.register("dwarven_mace", () -> new SwordItem(ItemTier.DWARVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DWARVEN, 8, -3.0f))));
    public static final Supplier<SwordItem> DWARVEN_WAR_AXE = ITEMS.register("dwarven_war_axe", () -> new SwordItem(ItemTier.DWARVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DWARVEN, 8, -2.8f))));
    public static final Supplier<SkyrimTwoHandedSword> DWARVEN_WARHAMMER = ITEMS.register("dwarven_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.DWARVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.DWARVEN, 10, -3.4f))));
    ...
    public static final Supplier<SwordItem> EBONY_WAR_AXE = ITEMS.register("ebony_war_axe", () -> new SwordItem(ItemTier.EBONY, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.EBONY, 9, -2.8f))));
    public static final Supplier<SkyrimTwoHandedSword> EBONY_WARHAMMER = ITEMS.register("ebony_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.EBONY, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.EBONY, 11, -3.4f))));
    ...
    public static final Supplier<ShieldItem> ELVEN_SHIELD = ITEMS.register("elven_shield", () -> new ShieldItem(new Item.Properties().stacksTo(1).durability(412)));
    ...
    public static final Supplier<SwordItem> ELVEN_DAGGER = ITEMS.register("elven_dagger", () -> new SwordItem(ItemTier.ELVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ELVEN, 4, -1.8f))));
    public static final Supplier<SwordItem> ELVEN_SWORD = ITEMS.register("elven_sword", () -> new SwordItem(ItemTier.ELVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ELVEN, 7, -2.4f))));
    public static final Supplier<SkyrimTwoHandedSword> ELVEN_BATTLEAXE = ITEMS.register("elven_battleaxe", () -> new SkyrimTwoHandedSword(ItemTier.ELVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ELVEN, 9, -3.2f))));
    public static final Supplier<SkyrimTwoHandedSword> ELVEN_GREATSWORD = ITEMS.register("elven_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.ELVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ELVEN, 8, -2.8f))));
    public static final Supplier<SwordItem> ELVEN_MACE = ITEMS.register("elven_mace", () -> new SwordItem(ItemTier.ELVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ELVEN, 8, -3.0f))));
    public static final Supplier<SwordItem> ELVEN_WAR_AXE = ITEMS.register("elven_war_axe", () -> new SwordItem(ItemTier.ELVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ELVEN, 8, -2.8f))));
    public static final Supplier<SkyrimTwoHandedSword> ELVEN_WARHAMMER = ITEMS.register("elven_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.ELVEN, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ELVEN, 10, -3.4f))));
    ...
    public static final Supplier<SwordItem> FALMER_SWORD = ITEMS.register("falmer_sword", () -> new SwordItem(ItemTier.FALMER, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.FALMER, 7, -2.4f))));
    public static final Supplier<SwordItem> FALMER_WAR_AXE = ITEMS.register("falmer_war_axe", () -> new SwordItem(ItemTier.FALMER, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.FALMER, 8, -2.8f))));
    ...
    public static final Supplier<ShieldItem> GLASS_SHIELD = ITEMS.register("glass_shield", () -> new ShieldItem(new Item.Properties().stacksTo(1).durability(336)));
    ...
    public static final Supplier<SwordItem> GLASS_DAGGER = ITEMS.register("glass_dagger", () -> new SwordItem(ItemTier.GLASS, (new Item.Properties()).attributes(SwordItem.createAttributes(ItemTier.GLASS, 3, -2.0F))));
    public static final Supplier<SwordItem> GLASS_SWORD = ITEMS.register("glass_sword", () -> new SwordItem(ItemTier.GLASS, (new Item.Properties()).attributes(SwordItem.createAttributes(ItemTier.GLASS, 4, -2.4F))));
    public static final Supplier<SkyrimTwoHandedSword> GLASS_BATTLEAXE = ITEMS.register("glass_battleaxe", () -> new SkyrimTwoHandedSword(ItemTier.GLASS, (new Item.Properties()).attributes(SwordItem.createAttributes(ItemTier.GLASS, 6, -3.0F))));
    public static final Supplier<SkyrimTwoHandedSword> GLASS_GREATSWORD = ITEMS.register("glass_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.GLASS, (new Item.Properties()).attributes(SwordItem.createAttributes(ItemTier.GLASS, 7, -3.0F))));
    public static final Supplier<SwordItem> GLASS_MACE = ITEMS.register("glass_mace", () -> new SwordItem(ItemTier.GLASS, (new Item.Properties()).attributes(SwordItem.createAttributes(ItemTier.GLASS, 5, -2.8F))));
    public static final Supplier<SwordItem> GLASS_WAR_AXE = ITEMS.register("glass_war_axe", () -> new SwordItem(ItemTier.GLASS, (new Item.Properties()).attributes(SwordItem.createAttributes(ItemTier.GLASS, 5, -2.8F))));
    public static final Supplier<SkyrimTwoHandedSword> GLASS_WARHAMMER = ITEMS.register("glass_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.GLASS, (new Item.Properties()).attributes(SwordItem.createAttributes(ItemTier.GLASS, 8, -3.2F))));
    ...
    public static final Supplier<ShieldItem> IRON_SHIELD = ITEMS.register("iron_shield", () -> new ShieldItem(new Item.Properties().stacksTo(1).durability(336)));
    ...
    public static final Supplier<ShieldItem> ORCISH_SHIELD = ITEMS.register("orcish_shield", () -> new ShieldItem(new Item.Properties().stacksTo(1).durability(528)));
    ...
    public static final Supplier<SwordItem> ORCISH_DAGGER = ITEMS.register("orcish_dagger", () -> new SwordItem(ItemTier.ORCISH, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ORCISH, 4, -2.0F))));
    public static final Supplier<SwordItem> ORCISH_SWORD = ITEMS.register("orcish_sword", () -> new SwordItem(ItemTier.ORCISH, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ORCISH, 5, -2.4F))));
    public static final Supplier<SkyrimTwoHandedSword> ORCISH_BATTLEAXE = ITEMS.register("orcish_battleaxe", () -> new SkyrimTwoHandedSword(ItemTier.ORCISH, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ORCISH, 7, -3.0F))));
    public static final Supplier<SkyrimTwoHandedSword> ORCISH_GREATSWORD = ITEMS.register("orcish_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.ORCISH, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ORCISH, 8, -3.0F))));
    public static final Supplier<SwordItem> ORCISH_MACE = ITEMS.register("orcish_mace", () -> new SwordItem(ItemTier.ORCISH, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ORCISH, 6, -2.8F))));
    public static final Supplier<SwordItem> ORCISH_WAR_AXE = ITEMS.register("orcish_war_axe", () -> new SwordItem(ItemTier.ORCISH, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ORCISH, 6, -2.8F))));
    public static final Supplier<SkyrimTwoHandedSword> ORCISH_WARHAMMER = ITEMS.register("orcish_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.ORCISH, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.ORCISH, 9, -3.2F))));
...
//    public static final Supplier<SkyrimArmor> STEEL_BOOTS = ITEMS.register("steel_boots", () -> new SkyrimArmor(ArmorMaterials.STEEL, ArmorItem.Type.BOOTS, new Item.Properties(), true));
    public static final Supplier<ShieldItem> STEEL_SHIELD = ITEMS.register("steel_shield", () -> new ShieldItem(new Item.Properties().stacksTo(1).durability(336)));
    ...
    public static final Supplier<SwordItem> STEEL_DAGGER = ITEMS.register("steel_dagger", () -> new SwordItem(ItemTier.STEEL, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.STEEL, 3, -2.0F))));
    public static final Supplier<SwordItem> STEEL_SWORD = ITEMS.register("steel_sword", () -> new SwordItem(ItemTier.STEEL, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.STEEL, 4, -2.4F))));
    public static final Supplier<SkyrimTwoHandedSword> STEEL_BATTLEAXE = ITEMS.register("steel_battleaxe", () -> new SkyrimTwoHandedSword(ItemTier.STEEL, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.STEEL, 6, -3.0F))));
    public static final Supplier<SkyrimTwoHandedSword> STEEL_GREATSWORD = ITEMS.register("steel_greatsword", () -> new SkyrimTwoHandedSword(ItemTier.STEEL, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.STEEL, 7, -3.0F))));
    public static final Supplier<SwordItem> STEEL_MACE = ITEMS.register("steel_mace", () -> new SwordItem(ItemTier.STEEL, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.STEEL, 5, -2.8F))));
    public static final Supplier<SwordItem> STEEL_WAR_AXE = ITEMS.register("steel_war_axe", () -> new SwordItem(ItemTier.STEEL, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.STEEL, 5, -2.8F))));
    public static final Supplier<SkyrimTwoHandedSword> STEEL_WARHAMMER = ITEMS.register("steel_warhammer", () -> new SkyrimTwoHandedSword(ItemTier.STEEL, (new Item.Properties()).fireResistant().attributes(SwordItem.createAttributes(ItemTier.STEEL, 8, -3.2F))));
    ...
    public static final Supplier<Item> OAKFLESH_SPELLBOOK = ITEMS.register("oakflesh_spellbook", () -> new SpellBook(new Item.Properties().rarity(Rarity.EPIC), SpellRegistry.OAKFLESH));
    public static final Supplier<Item> TELEKINESIS_SPELLBOOK = ITEMS.register("telekinesis_spellbook", () -> new SpellBook(new Item.Properties().rarity(Rarity.EPIC), SpellRegistry.TELEKINESIS));
    public static final Supplier<Item> WATERBREATHING_SPELLBOOK = ITEMS.register("waterbreathing_spellbook", () -> new SpellBook(new Item.Properties().rarity(Rarity.EPIC), SpellRegistry.WATERBREATHING));
