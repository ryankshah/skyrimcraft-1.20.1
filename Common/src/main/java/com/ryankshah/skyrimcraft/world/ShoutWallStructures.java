...
public class ShoutWallStructures extends Structure
{
    public static final MapCodec<ShoutWallStructures> CODEC = RecordCodecBuilder.<ShoutWallStructures>mapCodec(instance ->
            instance.group(ShoutWallStructures.settingsCodec(instance),
            ...
            ).apply(instance, ShoutWallStructures::new));//.codec();
    ...
    public ShoutWallStructures(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!ShoutWallStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return StructureRegistry.SHOUT_WALL.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}