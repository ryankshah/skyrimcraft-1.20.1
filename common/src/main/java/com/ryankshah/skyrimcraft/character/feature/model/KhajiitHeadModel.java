...
public class KhajiitHeadModel extends EntityModel<AbstractClientPlayer> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("player"), "khajiit_head");
    ...
    public void renderToBuffer(PoseStack pPoseStack, VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha) {
        ears.render(pPoseStack,  pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        Whiskers.render(pPoseStack,  pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
        nose.render(pPoseStack,  pBuffer, pPackedLight, pPackedOverlay, pRed, pGreen, pBlue, pAlpha);
    }
}