...
public class ShoutDismay extends Spell
{
    ...
    public ResourceLocation getDisplayAnimation() {
        return new ResourceLocation(Constants.MODID, "spells/dismay.png");
    }

    @Override
    public ResourceLocation getIcon() {
        return new ResourceLocation(Constants.MODID, "spells/icons/fireball.png");
    }
    ...
    @Override
    public void onCast() {
        getCaster().addEffect(new MobEffectInstance(ModEffects.DISMAY.get(), 600, 0, false, true, true));
        super.onCast();
    }
}
