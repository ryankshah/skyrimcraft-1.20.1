...
public class AlchemyScreen extends Screen
{
    ...
    public AlchemyScreen(List<AlchemyRecipe> recipes) {
        super(Component.translatable(Constants.MODID + ".alchemyscreen.title"));
...
//        );
        ...
        if (!this.items.isEmpty()) {
            ...
            for(int i = 0; i < categories.length; i++) {
                ...
                graphics.drawString(font, categoryName, 18, height / 2 + (i * 14) - this.currentCategory * font.lineHeight, i == currentCategory ? 16777215 : 12632256);
            }
...
//                        continue;
                    ...
                    graphics.drawString(font, name, 98, height / 2 + (i * 14) - this.currentItem * font.lineHeight, i == currentItem ? 16777215 : 12632256);
                }
            }
        }
...
//            PacketDistributor.SERVER.noArg().send(finishRecipe);
    ...
    private void drawItemInformation(GuiGraphics graphics, AlchemyRecipe recipe) {
    ...
    private void renderHealth(GuiGraphics graphics) {
        ...
        RenderUtil.blitWithBlend(matrixStack, (int)healthBarStartX, this.height - 23, 11, 64, (int)healthBarWidth, 6, 256, 256, 2, 1);
//        RenderUtil.bind(GuiComponent.GUI_ICONS_LOCATION);
    }
