...
public class GiantCampStructures extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final MapCodec<GiantCampStructures> CODEC = RecordCodecBuilder.<GiantCampStructures>mapCodec(instance ->
            instance.group(GiantCampStructures.settingsCodec(instance),
            ...
            ).apply(instance, GiantCampStructures::new));//.codec();
    ...
    public GiantCampStructures(StructureSettings config,
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if (!GiantCampStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return StructureRegistry.GIANT_CAMP.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}