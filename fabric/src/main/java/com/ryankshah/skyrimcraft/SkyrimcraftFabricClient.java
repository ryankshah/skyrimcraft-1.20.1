...
public class SkyrimcraftFabricClient implements ClientModInitializer
{
    ...
    public void onInitializeClient() {
        ...
        KeyBindingHelper.registerKeyBinding(KeysRegistry.PICKPOCKET_KEY);

        KeyBindingHelper.registerKeyBinding(KeysRegistry.SKYRIM_MENU_ENTER);
        KeyBindingHelper.registerKeyBinding(KeysRegistry.SKYRIM_MENU_NORTH);
        KeyBindingHelper.registerKeyBinding(KeysRegistry.SKYRIM_MENU_SOUTH);
        KeyBindingHelper.registerKeyBinding(KeysRegistry.SKYRIM_MENU_WEST);
        KeyBindingHelper.registerKeyBinding(KeysRegistry.SKYRIM_MENU_EAST);
...
//        if (mc.screen != null) return; // why was this duped lol
    ...
    public void addBlockRenders() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_METAL_BARS.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.STEEL_BARS.get(), RenderType.cutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_STONE_BUTTON.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_METAL_BUTTON.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_METAL_LEVER.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_METAL_CHAIN.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_METAL_DOOR.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_CHAIR.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_METAL_TALL_DOOR.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.STEEL_CELL_DOOR.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.STEEL_GATE_DOOR.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.STEEL_TALL_GATE.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_STONE_PRESSURE_PLATE.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_METAL_GATE.get(), RenderType.cutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_BLUE_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_LIGHT_BLUE_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_CYAN_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_GREY_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_LIGHT_GREY_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_GREEN_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_LIME_GREEN_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_YELLOW_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_ORANGE_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_PINK_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_PURPLE_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_MAGENTA_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_WHITE_CARPET.get(), RenderType.cutout());
        BlockRenderLayerMap.INSTANCE.putBlock(BlockRegistry.DWEMER_WOOL_RED_CARPET.get(), RenderType.cutout());
    }
