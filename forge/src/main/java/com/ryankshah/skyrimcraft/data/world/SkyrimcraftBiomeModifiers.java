...
public class SkyrimcraftBiomeModifiers
{
    ...
    private static final ResourceKey<BiomeModifier> OVERWORLD = ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(Constants.MODID, "overworld_skyrimcraft_spawns"));
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_ORICHALCUM_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                ...
                GenerationStep.Decoration.UNDERGROUND_ORES));
        context.register(ADD_QUICKSILVER_ORE, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
        ...
        context.register(ADD_MOUNTAIN_FLOWERS, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
        ...
        context.register(ADD_MUSHROOMS, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(WorldGenConstants.MUSHROOMS_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_DESERT_PLANTS, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                HolderSet.direct(placedFeatures.getOrThrow(WorldGenConstants.DESERT_PLANTS_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_OYSTERS, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_BEACH),
                HolderSet.direct(placedFeatures.getOrThrow(WorldGenConstants.OYSTERS_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_NESTS, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_FOREST),
        ...
        context.register(ADD_CREEP_CLUSTER, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_HILL),
                HolderSet.direct(placedFeatures.getOrThrow(WorldGenConstants.CREEP_CLUSTER_PLACED_KEY)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_PLAINS_FLYING_MOBS, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
                HolderSet.direct(
        ...
        context.register(ADD_DRIPSTONE_MOBS, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
                HolderSet.direct(
        ...
        context.register(ADD_SNOW_MOBS, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
                HolderSet.direct(
        ...
        context.register(ADD_PLAINS_MOBS, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
                HolderSet.direct(
        ...
        context.register(ADD_END_MOBS, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
        ...
        context.register(ADD_CAVE_MOBS, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                List.of(
        ...
        context.register(ADD_WATER_MOBS, new ForgeBiomeModifiers.AddSpawnsBiomeModifier(
                HolderSet.direct(
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, new ResourceLocation(Constants.MODID, name));
    }
}